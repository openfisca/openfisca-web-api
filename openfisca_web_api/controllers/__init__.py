...
from . import (calculate1, calculate2, entities, field, fields, formula, graph, parameters, reforms, simulate, swagger,
    variables)
...
def make_router():
    ...
    routings = [
        ...
        ('POST', '^/api/2/calculate/?$', calculate2.api2_calculate),
